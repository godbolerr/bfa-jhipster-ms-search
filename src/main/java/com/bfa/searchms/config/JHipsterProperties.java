...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "searchms@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "searchms API";

        private String description = "searchms API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "searchms";
